...
// slick carousel
wp_enqueue_script( 'slick-js', get_template_directory_uri() .
'/src/js/libs/slick/slick.min.js', array('jquery'), '1.0', true );
...
function estilosSripts() {
  if ( is_page( 'jornada' ) ) {
    ...
    wp_enqueue_style('normalize-css', get_template_directory_uri().'/css/normalize.css', false, 1.0, 'all' );
    wp_register_script( 'Rellax-js', 'https://cdnjs.cloudflare.com/ajax/libs/rellax/1.10.0/rellax.min.js', null, null, true );
    wp_enqueue_script('Rellax-js');
    wp_enqueue_script( 'scrolling-jquery', get_template_directory_uri() .'/src/js/jornada/jquery.scrolling.min.js', array('jquery'), '1.0', true ); 
    wp_enqueue_script( 'wow', get_stylesheet_directory_uri() . '/src/js/libs/wow/wow.js', array(), '', true );
    wp_enqueue_script( 'custom-js', get_template_directory_uri() .'/src/js/jornada/custom.js', array('jquery'), '1.0', true ); 
    wp_enqueue_script( 'menu-js', get_template_directory_uri() .'/src/js/jornada/menu-drawer.js', array('jquery'), '1.0', true ); 
    
  } 
    else if( is_page('home')){
      wp_enqueue_script( 'home-js', get_template_directory_uri().'/src/js/home.js', array('jquery'), '1.0', true );
    }
      ...
      wp_enqueue_script( 'slick-js', get_template_directory_uri() .
      '/src/js/libs/slick/slick.min.js', array('jquery'), '1.0', true ); 
      wp_enqueue_script('start-js', get_template_directory_uri().'/src/js/start.js', array('jquery'), '1.0', true);
    }
}
add_action( 'wp_enqueue_scripts', 'estilosSripts' );
add_action('wp_register_script','estilosSripts' );
